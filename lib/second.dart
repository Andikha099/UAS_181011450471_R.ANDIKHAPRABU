...
class _secondState extends State<second> {
  ...
  Future getweather() async {
    http.Response response = await http.get(
        "http://api.openweathermap.org/data/2.5/weather?q=${widget.text}&units=metric&appid=56ba2fa71990f5de5ce9ac5094bb528e");
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("1810111450471 - R.Andikha Prabu"),
      ),
      body:
